      ...
      <Card className={classes.root} bgcolor="info.main">
        <CardActionArea>
          {zomatoRest1PhotosURL ? (
            <CardMedia className={classes.media} image={zomatoRest1PhotosURL} />
          ) : null}
          <CardContent>
      ...
      <Card className={classes.root}>
        <CardActionArea>
          {zomatoRest2PhotosURL ? (
            <CardMedia className={classes.media} image={zomatoRest2PhotosURL} />
          ) : null}
          <CardContent>
            <Typography gutterBottom variant="h5" component="h2">
              {zomatoRest2Name}
      ...
      <Card className={classes.root}>
        <CardActionArea>
          {zomatoRest3PhotosURL ? (
            <CardMedia className={classes.media} image={zomatoRest3PhotosURL} />
          ) : null}
          <CardContent>
            <Typography gutterBottom variant="h5" component="h2">
              {zomatoRest3Name}
